...
public class ServiceHandler extends SimpleChannelInboundHandler< MethodInfoses.MyMessages> {
    ...
    public void channelRegistered(ChannelHandlerContext ctx) throws Exception {
        ...
        //这里需要需要调用的方法传输回去
        new sendinitmethods(channel).start();
    }
        ...
        public void  run() {
            ...
            if(o!=null) {
                ...
                for (Method declaredMethod : declaredMethods) {
                    //只需要对比hashcode的值就可以了
                    int i = declaredMethod.hashCode();
                    if (i == methodInfo.getMethodhashcode()) {
    ...
    class sendinitmethods extends Thread{
        public Channel channel;
        public sendinitmethods(Channel channel){
            this.channel = channel;
        }
        @Override
        public void run() {
